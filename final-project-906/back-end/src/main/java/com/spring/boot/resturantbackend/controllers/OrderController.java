...
public class OrderController {
    ...
    public ResponseEntity<ResponseOrderVm> createOrder(@RequestBody RequestOrderVm requestOrder) throws SystemException, URISyntaxException {
        return ResponseEntity.created(new URI("/create-order")).body(orderService.requestOrder(requestOrder));
    }
