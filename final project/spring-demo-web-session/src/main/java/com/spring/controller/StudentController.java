...
public class StudentController {
    ...
    ResponseEntity<Void> addListOfStudent(@Valid @RequestBody List<StudentDto> student) throws SystemException {
...
//    }
    ...
    @GetMapping("/allStudentWithTeacher")
    ResponseEntity<List<StudentDto>> getallStudentWithTeacher(){
        return ResponseEntity.ok(studentService.getStudentListWithTeacher());
    }
}
