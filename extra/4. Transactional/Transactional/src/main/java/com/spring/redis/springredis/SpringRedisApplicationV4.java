...
public class SpringRedisApplicationV4 implements CommandLineRunner {

    @Autowired
    private BankAccountRepository repo;

    @Autowired
    private BankServiceImplV4 bankService;

    public static void main(String[] args) {
        SpringApplication.run(SpringRedisApplicationV4.class, args);
    }
